...
CREATE TABLE `config_attributes` (
  `attribute_id` bigint(22) unsigned NOT NULL auto_increment,
...
INSERT INTO `config_attributes` (`attribute_id`,`name`,`description`) VALUES 
 ...
 (1010,'server.message.heap.server.service','-'),
 (1011,'server.message.heap.global','-'),
 (1012,'server.message.heap.client.service','-'),
 (1013,'server.network.cluster.id','Galaxy Cluster ID'),
