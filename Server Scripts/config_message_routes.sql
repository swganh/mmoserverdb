...
INSERT INTO `config_message_routes` (`messageId`,`processId`,`description`) VALUES 
 ...
 (-1632613473,1,'0x9EB04B9F - check_char_name - Checks a new characters name to make sure it is unique.  First name only.'),
 (-1257665162,1,'0xB5098D76 - SelectCharacter'),
 (-1198567066,1,'0xB88F5166 - ClusterZoneRegisterName'),
 (-1182846860,1,'0xB97F3074 - ClientChreateCharacter'),
 ...
 (-690899247,1,'0xD6D1B6D1 - verify_character_name'),
 ...
 (444250169,1,'0x1A7AB839 - GetMapLocationsMessage'),
