...
INSERT INTO `structure_item_template` (`id`,`structure_id`,`cell`,`item_type`,`relX`,`relY`,`relZ`,`dirX`,`dirY`,`dirZ`,`dirW`,`tan_type`,`rekW`) VALUES 
 (1,1,0,37,0.8,0,2,0,0,0,1,4,0),
 (2,1,0,287,0.8,0,4.1,0,0,0,1,7,0),
 (4,1,0,326,0.9,0,4.7,0,0.48,0,0.87,12,0),
 (5,1,0,369,0,0,5.2,0,0,0,1,7,0),
 (8,1,0,2768,-1.2,0,4.3,0,0.48,0,0.87,7,58),
 (9,1,0,1033,0.9,0,4.5,0,0,0,1,12,0);
