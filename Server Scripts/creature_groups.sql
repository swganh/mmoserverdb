...
CREATE TABLE `creature_groups` (
  ...
  `creatures_id` bigint(20) default NULL,
  PRIMARY KEY  (`id`,`creature_group_id`),
  KEY `fk_creature_groups_creatures` (`creatures_id`),
  CONSTRAINT `fk_creature_groups_creatures` FOREIGN KEY (`creatures_id`) REFERENCES `creatures` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `creature_groups` (`id`,`creature_group_id`,`creatures_id`) VALUES
 (1,1,1);
