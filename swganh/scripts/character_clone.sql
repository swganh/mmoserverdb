...
CREATE TABLE  `swganh`.`character_clone` (
  ...
  CONSTRAINT `FK_character_clone_charID` FOREIGN KEY (`character_id`) REFERENCES `characters` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_character_clone_planet` FOREIGN KEY (`planet_id`) REFERENCES `swganh_static`.`planet` (`planet_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_character_clone_buildingID` FOREIGN KEY (`spawn_facility_id`) REFERENCES `swganh_static`.`buildings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
