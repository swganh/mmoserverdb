...
:MainMenu
	...
	ECHO.   (6) swganh_logs                 ^|          Server Creation
...
:AccountsBackup
	...
	mysqldump --password=%db_pass% --host=%db_host% --user=%db_user% swganh account --extended-insert --create-options --dump-date --triggers --comments -r swganh_accounts.bak
